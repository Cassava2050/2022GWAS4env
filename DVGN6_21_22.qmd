...
The 202101DVGN6 layout plot needs to be fixed, because the planted is in cardinal way, where the correct way is in serpentine way

## Fixing errors in planting way
