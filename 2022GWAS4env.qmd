...
stab_values <- master_data[c(40:69)] %>% # select only stability elements
...
names(master_data)[56] <- "stability_root_commercial"
names(master_data)[26] <- "BLUP_BLUE_root_commercial"
names(master_data)[34] <- "BLUP_BLUE_germ_number_plot"
names(master_data)[64] <- "stability_germ_number_plot"
write.xlsx(master_data, file = meta_file_name)
```
