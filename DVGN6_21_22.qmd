...
trial_standard_new <- trial_standard %>%
  mutate(obs_harvest_number_plan =
         ...
         obs_yield_DM_ha = obs_DM_gravity * obs_yield_ha_v2 / 100)


# There is an error with obs_germinated_number_plot of 202232DVGN6_momi_rep1_BRA1001_153

trial_standard_new %>% select(use_plot_name, obs_germinated_number_plot, obs_planted_number_plot) %>% filter(obs_germinated_number_plot > 100)
```
